...
CSkeletonTracking::CSkeletonTracking() :
	handLeftX(Queue(QUEUE_SIZE)),
	handLeftY(Queue(QUEUE_SIZE)),
	handLeftZ(Queue(QUEUE_SIZE)),
	handRightX(Queue(QUEUE_SIZE)),
	handRightY(Queue(QUEUE_SIZE)),
	handRightZ(Queue(QUEUE_SIZE)),
	headX(Queue(QUEUE_SIZE)),
	headY(Queue(QUEUE_SIZE)),
	spineX(Queue(QUEUE_SIZE)),
	spineY(Queue(QUEUE_SIZE)),
	shoulderLeftX(Queue(QUEUE_SIZE)),
	shoulderLeftY(Queue(QUEUE_SIZE)),
	shoulderRightX(Queue(QUEUE_SIZE)),
	shoulderRightY(Queue(QUEUE_SIZE)),
	started(false)
{
	configureCamera();
}
